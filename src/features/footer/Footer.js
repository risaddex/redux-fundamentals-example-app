...
import { colorFilterChanged, selectTodos } from '../todos/todosSlice'
...
const Footer = () => {
  const dispatch = useDispatch() // IT IS NECESSARY.
  ...
  const clearAllCompleted = () => dispatch({ type: 'todos/completedCleared' })  
